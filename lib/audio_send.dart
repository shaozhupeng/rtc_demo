...
class _AudioSendState extends State<AudioSend> {
  ...
  void initState() {
    ...
    // 加入聊天室
    socketManager.emit('join', {'username': 'test', 'room': '123456'});
    // 接收语音
    socketManager.socket.on('audio_data', _handleAudioData);
    super.initState();
  }
  ...
  void stopRecorder() {
    ...
    socketManager.emit('stream_audio',
        {'username': 'test', 'room': '123456', 'data': cacheAudio.join('')});
  }
